...
- [x] 7. Create 75% compact layout JSON
...
- [x] 10. Create Numpad layout JSON
...
- [x] 12. Add layout validation tests
...
- [x] 13. Add KeyboardVisualizer layout integration tests
