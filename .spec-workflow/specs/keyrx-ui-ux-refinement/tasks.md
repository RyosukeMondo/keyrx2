...
- [x] 7. Create useProfileConfig hook in keyrx_ui/src/hooks/useProfileConfig.ts
...
- [x] 10. Add active profile header to MetricsPage in keyrx_ui/src/pages/MetricsPage.tsx
...
- [x] 21. Write E2E tests for visual config editor in keyrx_ui/tests/e2e/config-editor.spec.ts
